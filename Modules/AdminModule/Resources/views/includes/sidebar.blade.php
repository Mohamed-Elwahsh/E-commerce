    ...
    <div class="main-menu-content ">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-home"></i>
                ...
                <span class="badge badge badge-info badge-pill float-right mr-2">{{ Modules\CategoriesModule\Entities\Language::count() }}</span>
            </a>
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="{{ route('languages.all') }}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{ route('languages.create') }}" data-i18n="nav.dash.crypto">إضافة لغة جديدة</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <span class="badge badge badge-info badge-pill float-right mr-2">
                       {{ Modules\CategoriesModule\Entities\MainCategory::active()->count() }}
                </span>
            </a>
                <ul class="menu-content">
                    <li class="active">
                       <a class="menu-item" href="{{ route('maincategories.all') }}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
