                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> جميع الأقسام الرئيسية بالموقع </h4>
                                            ...
                                            @isset($mainCategories)
                                                @foreach($mainCategories as $mainCategory)
                                                    <tr>
                                                        ...
                                                        <td>{{ $mainCategory -> active == 1 ? 'مفعل'  : 'غير مفعل'; }}</td>
                                                        <td><img style="width: 100px; height: 100px" src="{{$mainCategory -> photo}}"></td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                 aria-label="Basic example">
                                                                <a href="{{ route('maincategories.edit', $mainCategory -> id) }}"
